(function () {
  ...
  (self["webpackChunkdelivermate_business"] = self["webpackChunkdelivermate_business"] || []).push([["src_app_phone-verification_phone-verification_module_ts"], {
    /***/
    47131: function _(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
      "use strict";
      ...
      __webpack_require__.d(__webpack_exports__, {
        /* harmony export */
        "PhoneVerificationPageRoutingModule": function PhoneVerificationPageRoutingModule() {
          return (
            /* binding */
            _PhoneVerificationPageRoutingModule
          );
        }
        /* harmony export */
      ...
      var _phone_verification_page__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(
      ...
      var _PhoneVerificationPageRoutingModule = function PhoneVerificationPageRoutingModule() {
        _classCallCheck(this, PhoneVerificationPageRoutingModule);
      };

      _PhoneVerificationPageRoutingModule = (0, tslib__WEBPACK_IMPORTED_MODULE_1__.__decorate)([(0, _angular_core__WEBPACK_IMPORTED_MODULE_2__.NgModule)({
    ...
    /***/
    53429: function _(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
      "use strict";
      ...
      __webpack_require__.d(__webpack_exports__, {
        /* harmony export */
        "PhoneVerificationPageModule": function PhoneVerificationPageModule() {
          return (
            /* binding */
            _PhoneVerificationPageModule
          );
        }
        /* harmony export */
      ...
      var _phone_verification_routing_module__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(
      /*! ./phone-verification-routing.module */
      47131);
      /* harmony import */


      var _phone_verification_page__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(
      /*! ./phone-verification.page */
      93253);

      var _PhoneVerificationPageModule = function PhoneVerificationPageModule() {
        _classCallCheck(this, PhoneVerificationPageModule);
      };

      _PhoneVerificationPageModule = (0, tslib__WEBPACK_IMPORTED_MODULE_2__.__decorate)([(0, _angular_core__WEBPACK_IMPORTED_MODULE_3__.NgModule)({
        imports: [_angular_common__WEBPACK_IMPORTED_MODULE_4__.CommonModule, _angular_forms__WEBPACK_IMPORTED_MODULE_5__.FormsModule, _angular_forms__WEBPACK_IMPORTED_MODULE_5__.ReactiveFormsModule, _ionic_angular__WEBPACK_IMPORTED_MODULE_6__.IonicModule, _phone_verification_routing_module__WEBPACK_IMPORTED_MODULE_0__.PhoneVerificationPageRoutingModule],
    ...
    93253: function _(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
      ...
      __webpack_require__.d(__webpack_exports__, {
        /* harmony export */
        "PhoneVerificationPage": function PhoneVerificationPage() {
          return (
            /* binding */
            _PhoneVerificationPage
          );
        }
        /* harmony export */
      ...
      var _raw_loader_phone_verification_page_html__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(
      /*! !raw-loader!./phone-verification.page.html */
      35095);
      /* harmony import */


      var _phone_verification_page_scss__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(
      ...
      var _PhoneVerificationPage = /*#__PURE__*/function () {
        function PhoneVerificationPage(apiServices, toastController, formBuilder, loginService, storage, router) {
        ...
        _createClass(PhoneVerificationPage, [{
          ...
          value: function generateVerificationCode(type) {
            var _this = this;
            ...
            if (type == 'SMS') {
              ...
              console.log(data);
              this.apiServices.post("generate-verification-code", data).subscribe(function (res) {
                console.log(res);
                _this.waitText = null;
              }, function (error) {
                console.log(error);
          ...
          key: "verifyVerificationCode",
          value: function verifyVerificationCode(formValues) {
            var _this2 = this;
            ...
            if (this.codeForm.valid) {
              ...
              data['type'] = "mobile";
              console.log(data);
              this.apiServices.post("verify-verification-code", data).subscribe(function (res) {
                console.log(res);
                var user = _this2.loginService.currentUser.value;
                user.userDetails.verifiedMobileNumber = true;

                _this2.loginService.currentUser.next(user);

                _this2.storage.set('userDetails', user);

                _this2.waitText = null; // if (currentUser.userDetails.verifiedMobileNumber == true ) {
                ...
                _this2.router.navigate(['business-dashboard']);
              }, function (error) {
                console.log(error);
                _this2.waitText = null;
              }); // }
            } else {
              this.waitText = null;
      ...
      _PhoneVerificationPage.ctorParameters = function () {
        return [{
      ...
      _PhoneVerificationPage = (0, tslib__WEBPACK_IMPORTED_MODULE_9__.__decorate)([(0, _angular_core__WEBPACK_IMPORTED_MODULE_10__.Component)({
    ...
    /***/
    21150: function _(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
      "use strict";
    ...
    /***/
    35095: function _(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
      "use strict";
...
//# sourceMappingURL=src_app_phone-verification_phone-verification_module_ts-es5.js.map