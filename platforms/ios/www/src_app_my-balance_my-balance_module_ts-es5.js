(function () {
  ...
  (self["webpackChunkdelivermate_business"] = self["webpackChunkdelivermate_business"] || []).push([["src_app_my-balance_my-balance_module_ts"], {
    /***/
    21626: function _(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
      "use strict";
      ...
      __webpack_require__.d(__webpack_exports__, {
        /* harmony export */
        "MyBalancePageRoutingModule": function MyBalancePageRoutingModule() {
          return (
            /* binding */
            _MyBalancePageRoutingModule
          );
        }
        /* harmony export */
      ...
      var _my_balance_page__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(
      /*! ./my-balance.page */
      71893);
      ...
      var _MyBalancePageRoutingModule = function MyBalancePageRoutingModule() {
        _classCallCheck(this, MyBalancePageRoutingModule);
      };

      _MyBalancePageRoutingModule = (0, tslib__WEBPACK_IMPORTED_MODULE_1__.__decorate)([(0, _angular_core__WEBPACK_IMPORTED_MODULE_2__.NgModule)({
    ...
    96078: function _(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
      ...
      __webpack_require__.d(__webpack_exports__, {
        /* harmony export */
        "MyBalancePageModule": function MyBalancePageModule() {
          return (
            /* binding */
            _MyBalancePageModule
          );
        }
        /* harmony export */
      ...
      var _my_balance_routing_module__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(
      /*! ./my-balance-routing.module */
      21626);
      /* harmony import */


      var _my_balance_page__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(
      /*! ./my-balance.page */
      71893);

      var _MyBalancePageModule = function MyBalancePageModule() {
        _classCallCheck(this, MyBalancePageModule);
      };

      _MyBalancePageModule = (0, tslib__WEBPACK_IMPORTED_MODULE_2__.__decorate)([(0, _angular_core__WEBPACK_IMPORTED_MODULE_3__.NgModule)({
        imports: [_angular_common__WEBPACK_IMPORTED_MODULE_4__.CommonModule, _angular_forms__WEBPACK_IMPORTED_MODULE_5__.FormsModule, _ionic_angular__WEBPACK_IMPORTED_MODULE_6__.IonicModule, _my_balance_routing_module__WEBPACK_IMPORTED_MODULE_0__.MyBalancePageRoutingModule],
    ...
    /***/
    71893: function _(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
      "use strict";
      ...
      __webpack_require__.d(__webpack_exports__, {
        /* harmony export */
        "MyBalancePage": function MyBalancePage() {
          return (
            /* binding */
            _MyBalancePage
          );
      ...
      var _raw_loader_my_balance_page_html__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(
      /*! !raw-loader!./my-balance.page.html */
      91223);
      /* harmony import */


      var _my_balance_page_scss__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(
      ...
      var _MyBalancePage = /*#__PURE__*/function () {
        function MyBalancePage(apiServices, loginService, alertController) {
        ...
        _createClass(MyBalancePage, [{
          ...
          value: function ngOnInit() {
            ...
            this.savedCards$ = this.apiServices.get('retrieve-stored-card', 'businessId=' + user.userDetails.id).pipe((0, rxjs_operators__WEBPACK_IMPORTED_MODULE_4__.tap)(function (cards) {
              return "cards:" + cards;
          ...
          value: function ionViewWillEnter() {
            ...
            this.savedCards$.subscribe(function (res) {
              console.log(res);
            });
            this.getAccount();
          }
          ...
          value: function getAccount() {
            var user = this.loginService.currentUser.value;
            this.account$ = this.apiServices.get('retrieve-account', 'id=' + user.userDetails.id).pipe((0, rxjs_operators__WEBPACK_IMPORTED_MODULE_4__.tap)(function (account) {
          ...
          key: "handleCardDeletion",
          value: function handleCardDeletion(cardId) {
            this.confirmDeletionAlert(cardId);
          }
        }, {
          key: "confirmDeletionAlert",
          value: function confirmDeletionAlert(cardId) {
                      ...
                      return this.alertController.create({
                        ...
                        buttons: [{
                          ...
                          handler: function handler() {
                            _this.apiServices["delete"]('remove-stored-card', 'businessId=' + _this.user.userDetails.id + '&cardId=' + cardId).subscribe(function (res) {
                              console.log(res);
                              _this.savedCards$ = (0, rxjs__WEBPACK_IMPORTED_MODULE_8__.of)(res);
                            }, function (error) {
                              console.log(error);
                            });
                          }
      ...
      _MyBalancePage.ctorParameters = function () {
        return [{
      ...
      _MyBalancePage = (0, tslib__WEBPACK_IMPORTED_MODULE_7__.__decorate)([(0, _angular_core__WEBPACK_IMPORTED_MODULE_10__.Component)({
    ...
    /***/
    81792: function _(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
      "use strict";
    ...
    /***/
    91223: function _(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
      "use strict";
...
//# sourceMappingURL=src_app_my-balance_my-balance_module_ts-es5.js.map