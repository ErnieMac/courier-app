...
/***/ 65035:
/*!*******************************************************************!*\
  !*** ./src/app/add-new-address/add-new-address-routing.module.ts ***!
  \*******************************************************************/
...
/* harmony export */   "AddNewAddressPageRoutingModule": function() { return /* binding */ AddNewAddressPageRoutingModule; }
/* harmony export */ });
/* harmony import */ var tslib__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! tslib */ 64762);
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! @angular/core */ 37716);
/* harmony import */ var _angular_router__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! @angular/router */ 39895);
/* harmony import */ var _add_new_address_page__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./add-new-address.page */ 92210);
...
AddNewAddressPageRoutingModule = (0,tslib__WEBPACK_IMPORTED_MODULE_1__.__decorate)([
...
/***/ 8543:
/*!***********************************************************!*\
  !*** ./src/app/add-new-address/add-new-address.module.ts ***!
  \***********************************************************/
/***/ (function(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "AddNewAddressPageModule": function() { return /* binding */ AddNewAddressPageModule; }
/* harmony export */ });
...
/* harmony import */ var _add_new_address_routing_module__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./add-new-address-routing.module */ 65035);
/* harmony import */ var _add_new_address_page__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./add-new-address.page */ 92210);
/* harmony import */ var _shared_google_auto_complete_places_auto_complete_places_component__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../shared/google/auto-complete-places/auto-complete-places.component */ 41371);
/* harmony import */ var _angular_google_maps__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! @angular/google-maps */ 99010);
...
AddNewAddressPageModule = (0,tslib__WEBPACK_IMPORTED_MODULE_3__.__decorate)([
    (0,_angular_core__WEBPACK_IMPORTED_MODULE_4__.NgModule)({
        imports: [
            ...
            _add_new_address_routing_module__WEBPACK_IMPORTED_MODULE_0__.AddNewAddressPageRoutingModule
        ],
...
/***/ 92210:
/*!*********************************************************!*\
  !*** ./src/app/add-new-address/add-new-address.page.ts ***!
  \*********************************************************/
/***/ (function(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "AddNewAddressPage": function() { return /* binding */ AddNewAddressPage; }
/* harmony export */ });
/* harmony import */ var tslib__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! tslib */ 64762);
/* harmony import */ var _raw_loader_add_new_address_page_html__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! !raw-loader!./add-new-address.page.html */ 19046);
/* harmony import */ var _add_new_address_page_scss__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./add-new-address.page.scss */ 38384);
...
/* harmony import */ var _ionic_storage_angular__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(/*! @ionic/storage-angular */ 61628);
...
/* harmony import */ var _services_address_service_service__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ../services/address-service.service */ 77900);
...
let AddNewAddressPage = class AddNewAddressPage {
    constructor(apiServices, formBuilder, loginService, router, storage, addressService, httpClient) {
        ...
        this.apiLoaded = httpClient.jsonp('https://maps.googleapis.com/maps/api/js?v=3.exp&libraries=places&key=AIzaSyAd9vZGWXanh-zvkphgh6tcLN0sqDkxgcg', 'callback')
            .pipe((0,rxjs_operators__WEBPACK_IMPORTED_MODULE_5__.map)(() => true), (0,rxjs_operators__WEBPACK_IMPORTED_MODULE_6__.catchError)(() => (0,rxjs__WEBPACK_IMPORTED_MODULE_7__.of)(false)));
    }
    ngOnInit() {
        ...
        return (0,tslib__WEBPACK_IMPORTED_MODULE_9__.__awaiter)(this, void 0, void 0, function* () {
            ...
            if (this.formGroup.valid) {
                if (payLoad['saveAddress']) {
                    ...
                    let unSavedAddress = [];
                    let localAddresses = yield this.storage.get('unsaved-addresses');
...
AddNewAddressPage = (0,tslib__WEBPACK_IMPORTED_MODULE_9__.__decorate)([
...
/***/ 41371:
/*!**************************************************************************************!*\
  !*** ./src/app/shared/google/auto-complete-places/auto-complete-places.component.ts ***!
  \**************************************************************************************/
/***/ (function(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "AutoCompletePlacesComponent": function() { return /* binding */ AutoCompletePlacesComponent; }
/* harmony export */ });
/* harmony import */ var tslib__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! tslib */ 64762);
/* harmony import */ var _raw_loader_auto_complete_places_component_html__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! !raw-loader!./auto-complete-places.component.html */ 63317);
/* harmony import */ var _auto_complete_places_component_scss__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./auto-complete-places.component.scss */ 94506);
...
let AutoCompletePlacesComponent = class AutoCompletePlacesComponent {
    constructor(geolocation, nativeGeocoder, zone, addressService) {
...
AutoCompletePlacesComponent.ctorParameters = () => [
    { type: _ionic_native_geolocation_ngx__WEBPACK_IMPORTED_MODULE_2__.Geolocation },
    { type: _ionic_native_native_geocoder_ngx__WEBPACK_IMPORTED_MODULE_3__.NativeGeocoder },
    { type: _angular_core__WEBPACK_IMPORTED_MODULE_5__.NgZone },
    { type: _services_address_service_service__WEBPACK_IMPORTED_MODULE_4__.AddressServiceService }
];
AutoCompletePlacesComponent.propDecorators = {
    adressType: [{ type: _angular_core__WEBPACK_IMPORTED_MODULE_5__.Input }],
    setAddress: [{ type: _angular_core__WEBPACK_IMPORTED_MODULE_5__.Output }],
    addresstext: [{ type: _angular_core__WEBPACK_IMPORTED_MODULE_5__.ViewChild, args: ['addresstext',] }],
    places: [{ type: _angular_core__WEBPACK_IMPORTED_MODULE_5__.ViewChild, args: ["places",] }],
    mapElement: [{ type: _angular_core__WEBPACK_IMPORTED_MODULE_5__.ViewChild, args: ['map', { static: false },] }]
};
AutoCompletePlacesComponent = (0,tslib__WEBPACK_IMPORTED_MODULE_6__.__decorate)([
...
/***/ 38384:
/*!***********************************************************!*\
  !*** ./src/app/add-new-address/add-new-address.page.scss ***!
  \***********************************************************/
/***/ (function(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
...
/***/ 94506:
/*!****************************************************************************************!*\
  !*** ./src/app/shared/google/auto-complete-places/auto-complete-places.component.scss ***!
  \****************************************************************************************/
/***/ (function(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
...
/***/ 19046:
/*!*************************************************************************************************!*\
  !*** ./node_modules/raw-loader/dist/cjs.js!./src/app/add-new-address/add-new-address.page.html ***!
  \*************************************************************************************************/
/***/ (function(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
...
/***/ 63317:
/*!******************************************************************************************************************************!*\
  !*** ./node_modules/raw-loader/dist/cjs.js!./src/app/shared/google/auto-complete-places/auto-complete-places.component.html ***!
  \******************************************************************************************************************************/
/***/ (function(__unused_webpack_module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony default export */ __webpack_exports__["default"] = ("<ion-searchbar class=\"search-bar\" [(ngModel)]=\"autocomplete.input\" (ionInput)=\"UpdateSearchResults()\"\n  placeholder=\"Search for a place\" (ionClear)=\"ClearAutocomplete()\">\n</ion-searchbar>\n\n<ion-list [hidden]=\"autocompleteItems.length == 0 || hideList\">\n  <ion-item *ngFor=\"let item of autocompleteItems\" tappable (click)=\"SelectSearchResult(item)\">\n    {{ item.description }}\n  </ion-item>\n</ion-list>\n\n<!-- <ion-input #places type=\"text\" name=\"search\"></ion-input> -->");

/***/ })

}]);
//# sourceMappingURL=src_app_add-new-address_add-new-address_module_ts-es2015.js.map